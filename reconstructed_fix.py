...
def generate_dag_code(
    ...
    # Airflow 3.0.6 oriented DAG code template.
    # Uses Task SDK DAG class and Standard provider operators.
...
def execute_node(task_key, node_id, node_name, engine, execution_mode, **kwargs):
    ...
    # Marker for finalize_results (Airflow 3 safe; avoids ORM/DB reads).
